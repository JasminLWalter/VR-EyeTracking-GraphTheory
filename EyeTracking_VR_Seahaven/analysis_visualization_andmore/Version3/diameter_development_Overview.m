...
for ii = 1:Number
    ...
    % remove node noData and newSession from graph if they are in graph
            if findnode(graphyNoData, 'noData') > 0 
                graphyNoData = rmnode(graphyNoData, 'noData');
                
            elseif findnode(graphyNoData, 'newSession') > 0
                graphyNoData = rmnode(graphyNoData, 'newSession');                
