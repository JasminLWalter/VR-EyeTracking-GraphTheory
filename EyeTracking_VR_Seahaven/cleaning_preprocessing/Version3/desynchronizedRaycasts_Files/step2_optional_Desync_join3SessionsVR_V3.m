...
savepath = 'D:\Studium\NBP\Seahaven\90min_Data\Desynchronization\desync_combined3sessions\';

cd 'D:\Studium\NBP\Seahaven\90min_Data\Desynchronization\Desync_condensedColliders\';
...
PartList = {1909 3668 8466 3430 6348 8551 9437 1540 1155};
...
for part = 1: height(combinedSessions)
    ...
    for shiftIndex = 1:maxShiftNr
        ...
        data1 = load(strcat(num2str(combinedSessions.Session1(part)),'_',num2str(currentShift),'sec_shift_condensedColliders_V3.mat'));
        data1 = data1.condensedData;

        data2 = load(strcat(num2str(combinedSessions.Session2(part)),'_',num2str(currentShift),'sec_shift_condensedColliders_V3.mat'));
        data2 = data2.condensedData;

        data3 = load(strcat(num2str(combinedSessions.Session3(part)),'_',num2str(currentShift),'sec_shift_condensedColliders_V3.mat'));
        ...
        newName = strcat(num2str(combinedSessions.newPartNumber(part)),'_',num2str(currentShift),'sec_shift_condensedColliders_3Sessions_V3');
