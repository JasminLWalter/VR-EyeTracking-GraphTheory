...
savepath = 'D:\Studium\NBP\Seahaven\90min_Data\Desynchronization\desync_interpolatedColliders\';

cd 'D:\Studium\NBP\Seahaven\90min_Data\Desynchronization\desync_combined3sessions\'
...
for ii = 1:Number
    ...
    for shiftIndex = 1:maxShiftNr
        ...
        file = strcat(num2str(currentPart),'_',num2str(currentShift),'sec_shift_condensedColliders_3Sessions_V3.mat');
    ...
    %                         
            ...
            save([savepath num2str(currentPart),'_',num2str(currentShift),'sec_shift_interpolatedColliders_3Sessions_V3.mat'],'interpolatedData');
