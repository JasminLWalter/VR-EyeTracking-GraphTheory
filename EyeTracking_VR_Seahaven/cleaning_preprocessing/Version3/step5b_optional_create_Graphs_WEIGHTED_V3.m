%% ------------------ create_Graphs b - weighted - Version 3-------------------------------------
...
savepath= 'E:\NBP\SeahavenEyeTrackingData\90minVR\Version03\preprocessing\graphs_weighted\';
...
%% save graph
        save([savepath num2str(currentPart) '_Graph_weighted_V3.mat'],'graphyW');
