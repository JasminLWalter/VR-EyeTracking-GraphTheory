...
%savepaths
savepath = 'E:\Cyprus_project_overview\data\analysis\exploration\eyeTracking\graph-analysis-pipeline\richClub\';
...
landmarkPath = 'E:\Cyprus_project_overview\data\analysis\exploration\eyeTracking\graph-analysis-pipeline\nodeDegree_landmarks\';
...
houseList = colliderList.buildingNames;

% load landmark overview

landmarks = readtable(strcat(landmarkPath, 'list_gaze_graph_defined_landmarks.csv'));
landmarks = landmarks.nodes;
...
%     set(gca,'FontName','Helvetica','FontSize',40,'FontWeight','bold')
    ...
    if saving_wanted == true
        saveas(gcf,strcat(savepath,'RichClub_Coefficient.png'),'png');
    end
    hold off
