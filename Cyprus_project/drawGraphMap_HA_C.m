...
savepath = 'F:\Cyprus_project_overview\data\comparison2VR\10min\graphsHA\graphsOnMap\';
...
cd 'F:\Cyprus_project_overview\data\comparison2VR\10min\graphsHA\';
...
%         saveas(gcf,strcat(savepath,num2str(currentPart),'_Graph_visualizationMap.png'),'png');
        ...
        ax = gca;
        exportgraphics(ax,strcat(savepath,num2str(currentPart),'_Graph_visualizationMap.png'))
