...
savepath = 'E:\SeahavenEyeTrackingData\duringProcessOfCleaning\gazes_vs_noise\';
...
for ii = 1:Number
    ...
    elseif exist(file)==2
        ...
        overviewGazes.totalAmount(countAnalysedPart)= height(interpolatedData);
        overviewGazes.gazes(countAnalysedPart)= height(gazedObjects);
        overviewGazes.noise(countAnalysedPart) = height(noisyObjects);
