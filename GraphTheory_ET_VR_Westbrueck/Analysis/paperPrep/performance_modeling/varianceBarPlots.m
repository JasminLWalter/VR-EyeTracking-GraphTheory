...
x = 1;
y = [100,0,0,0,0; 67.2,0,0,0,32.8; 58.5,9.17,0,0,32.8; 54.36,0,12.84,0,32.8; 45.19,0,0,22.01, 32.8];
figure(1)
...
plotty1(4).FaceColor = [0.24,0.80,0.65];
plotty1(5).FaceColor = [0.75,0.75,0.75];
...
x = 1;
y = [67.2,0,0,32.8; 58.03,9.17,0,32.8; 47,0,12.84,32.8];
