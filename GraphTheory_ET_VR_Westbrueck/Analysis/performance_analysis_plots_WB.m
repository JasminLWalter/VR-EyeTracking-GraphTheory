...
savepath = 'E:\Westbrueck Data\SpaRe_Data\1_Exploration\Analysis\P2B_controls_analysis\performance_graph_properties_analysis\';
...
for index3 = 1:length(sortedParticipantIDs)
    ...
    for index4 = 1: height(uniqueTrials)
        ...
        trials = selection.RecalculatedAngle(start & target)';
        
        
        trialPerformance(1,index4*2-1) = trials(1);
        trialPerformance(1,index4*2) = trials(2);
