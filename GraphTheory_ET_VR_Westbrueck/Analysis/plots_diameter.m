...
savepathMaxDPlots = 'E:\WestbrookProject\SpaRe_Data\control_data\Analysis\tempDevelopment\1minSections\AnalysisDiameter\maxDiameterGif\';
savepathEndDPlots = 'E:\WestbrookProject\SpaRe_Data\control_data\Analysis\tempDevelopment\1minSections\AnalysisDiameter\endDiameterGif\';
...
cd 'E:\WestbrookProject\SpaRe_Data\control_data\Analysis\tempDevelopment\1minSections\AnalysisDiameter\';
...
for index = 7:9
    ...
    plotty2 = scatter([overviewMaxDiameter(isI).maxDiameter], [overviewMaxDiameter(isI).NumMaxDiameters], 20,colors2_3Values(index-6,:), 'filled','DisplayName', num2str(index));
    hold on
...
legendNames = {'diameter = 7', 'diameter = 8', 'diameter = 9'};
...
for index6 = 1:length(overviewEndDiameter)
   ...
   for ee = 1:height(startNodes)
        ...
        line([x1,x2],[y1,y2],'Color',colors2_3Values((overviewEndDiameter(index6).endDiameter-6),:),'LineWidth',0.5); 
    ...
    plotty6 = scatter(x,y, 20,colors2_3Values((overviewEndDiameter(index6).endDiameter-6),:),'filled');
...
for index = 7:9
    ...
    plotty7 = scatter([overviewEndDiameter(isI).endDiameter], [overviewEndDiameter(isI).NumMaxDiameters], 20,colors2_3Values(index-6,:), 'filled','DisplayName', num2str(index));
    hold on
