...
disp("statistics Fiedler value")
disp(['mean Fiedler value = ', num2str(meanStats.Eigenvalue2L)])
disp(['std Fiedler value = ', num2str(stdStats.Eigenvalue2L)])

disp('-----------------------------------')
disp('mean edge statistics')
meanEdges = mean(Cut_Edges);
disp(meanEdges(:,2:end))

disp('std edge statistics')
stdEdges = std(Cut_Edges);
disp(stdEdges(:,2:end))
