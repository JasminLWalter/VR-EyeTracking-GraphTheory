    ...
    for indexSess = 1:5
        ...
        if isempty(dirSess)
            ...
            for indexET = 1:length(fileNames_sorted)
                ...
                % dSelect.processedCollider_name = data.processedCollider_name;
                % 
                % dSelect.processedCollider_hitPointOnObject_x = data.processedCollider_hitPointOnObject_x;
                % dSelect.processedCollider_hitPointOnObject_y = data.processedCollider_hitPointOnObject_y;
                % dSelect.processedCollider_hitPointOnObject_z = data.processedCollider_hitPointOnObject_z;
                % 
                % dSelect.processedCollider_hitObjectColliderBoundsCenter_x = data.processedCollider_hitObjectColliderBoundsCenter_x;
                % dSelect.processedCollider_hitObjectColliderBoundsCenter_y = data.processedCollider_hitObjectColliderBoundsCenter_y;
                % dSelect.processedCollider_hitObjectColliderBoundsCenter_z = data.processedCollider_hitObjectColliderBoundsCenter_z;
...
writetable(allData,strcat(savepath, "combinedProcessedColliderData.csv"))
