...
savepath = 'D:\BA Backup\Data_after_Script\approach2-fixations\viewingDurations\simultaneously\';
...
for ii = 1:Number
    ...
    elseif exist(file)==2
        ...
        houses = strcmp(AllSeen.House(:),'sky') | strcmp(AllSeen.House(:),'NH');             
        ...
        hist1 = histogram(housesTable.Looks,'BinWidth',binsize);
        ...
        figure(2)  
        hist2 = histogram(housesTable.Looks,'BinWidth',binsize);
        ...
        combineDursT.Time(big30)= 31;
          ...
          figure(3);
          hist3= histogram(combineDursT.Looks, 'BinWidth',binsize);
