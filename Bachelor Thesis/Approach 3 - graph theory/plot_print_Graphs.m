...
savepath = 'D:\BA Backup\Data_after_Script\approach3-graphs\plots\matlabLayout\';
...
for ii = 1:Number
    ...
    elseif exist(file)==2
        ...
        title(strcat('Graph - Participant: ',num2str(currentPart),' - Matlab-layout'));

        % print graph as png
        saveas(gcf,strcat(savepath,'graph_',num2str(currentPart),'.png'),'png');
        % print graph as pdf
