...
savepath = 'D:\BA Backup\Data_after_Script\approach3-graphs\plots\mapLayout\';
...
map = imread ('D:\BA Backup\Data_after_Script\Map, CoordinateList\Map_ResolutionWhite.png');
...
%         plotty = scatter(coordinateList.X,coordinateList.Y,'filled','b');
        ...
        title(strcat('Graph - Participant: ',num2str(currentPart),' - layout map Seahaven'));
...
%---------comment code until here to only show nodes without edges--------
      ...
      saveas(gcf,strcat(savepath,'Graph aligned with map coordinates Participant ',num2str(currentPart),'.png'),'png');
